...
The simple substitution feature allows you to substitute and maintain products in the product master data and reference substitute products during order creation. This feature can be turned on when you need to substitute one product with another product for a limited period of time. 
