---
author: josaw1
description: Learn about how to set up a Dynamics 365 Intelligent Order Management environment.
ms.date: 01/28/2026
ms.custom: 
  - bap-template
ms.topic: how-to
...
:::image type="content" source="media/welcome2.png" alt-text="Screenshot of the Welcome and get started page.":::
...
To configure Intelligent Order Management, you first need to create a Dataverse connection and a Power Automate Management connection.

1. Go to the [Power Automate portal](https://us.flow.microsoft.com/) and make sure you're in the correct Intelligent Order Management environment. To check which environment you're in, select **Environments** in the top-right corner of the Power Automate portal.
1. Go to **Data > Connections**.

### Create Dataverse connection

1. On **Data > Connections**, select **New connection**.
1. In the search box in the top-right corner, enter **Dataverse**.
1. Select **+** next to **Microsoft Dataverse**.

:::image type="content" source="media/dataverse-connection.png" alt-text="Screenshot of the Dataverse connection option.":::

1. Select **Create**. When prompted to sign in, use the same credentials you used to sign in to Intelligent Order Management.

### Create Power Automate connection

1. On **Data > Connections**, select **New connection**.
1. In the search box in the top-right corner, enter **Power Automate Management**.
1. Select **+** next to **Power Automate Management**. When prompted to sign in, use the same credentials you used to sign in to Intelligent Order Management.

### Create HTTP with Microsoft Entra ID (preauthorized) connection

1. On **Data > Connections**, select **New connection**.
1. In the search box in the top-right corner, enter **HTTP with Microsoft Entra**.
1. Select **+** next to **HTTP with Microsoft Entra ID (preauthorized)**.
1. Select **Connect directly (cloud-services)**. For **Base Resource URL**, enter the URL of your Dataverse environment, similar to `https://orgurl.crm.dynamics.com`. For **Microsoft Entra ID Resource URI (Application ID URI)**, enter the same URL of your Dataverse environment.
1. When prompted to sign in, use the same credentials you used to sign in to Intelligent Order Management.
...
1. Once you configure all of the platform connection references, select **Activate System** in Intelligent Order Management to turn on the related platform Power Automate flows. This step might take a while. 
