---
author: josaw1
description: Learn about the steps required to create order orchestration in Microsoft Dynamics 365 Intelligent Order Management.
ms.date: 01/28/2026
ms.custom: 
  - bap-template
ms.topic: how-to
...
1. In the **Validate order header** dialog box, complete the following fields:
...
1. In the **Validate order line** dialog box, complete the following fields:
...
1. In the **Custom** dialog box, complete the following steps:
...
1. In the **Splitter** dialog box, complete the following steps:
...
1. In the **Send to fulfillment** dialog box, complete the following steps:
...
After you finish creating the order orchestration flow, select **Publish** to publish the flow.

If you followed the steps, you see the transpiled Power Automate cloud flows as shown in the following illustration.
