...
Custom entity orchestration enables you to orchestrate custom Microsoft Dataverse entities that you create for business purposes. For example, custom entity orchestration is a good choice if you need to create a nonstandard entity to orchestrate fulfillment or transportation processes.
...
1. Create a custom table in Power Apps. This table is any custom table that you create outside the out-of-box business Dataverse entities that are available for orchestration.
...
1. Create a record in the **IOM entity metadata** table. You can look up records by using settings and columns on the custom entity:
    ...
    - **Plural Name** is the plural logical name that you set at creation.
